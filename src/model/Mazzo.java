...
public class Mazzo <T extends Carta> {
    private AbstractQueue<T> mazzo = new LinkedBlockingQueue<T>(); //l'interfaccia LinkedBlockingQueue implementa BlockingQueue che estende Queue. Queue rappresenta una FIFO.
    ...
    public void addCarte(AbstractQueue<T> carte) {
        mazzo.addAll(carte);
    }
